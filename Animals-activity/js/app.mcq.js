...
function loadQuestion(itr) {
    ...
    for (i = 0; i < q_set[itr].length; i++) {
        ...
        if (total_que == current_que) {
            ...
            setTimeout(function () {
                console.log("i am in the last section");
                $('#last').removeClass('d-none');
                $('#last').addClass('d-block');

                $('#last-vid').removeClass('d-none');
                $('#last-vid').addClass('d-block');

                $('#vdo15').removeClass('d-block');
                $('#vdo15').addClass('d-none');
    ...
    if (!incorrect) {
        ...
        if (sc >= 4) {
            ...
            setTimeout(function () { 
                ...
                $(vdo3).removeClass('d-none');
                $(vdo3).addClass('d-block');
